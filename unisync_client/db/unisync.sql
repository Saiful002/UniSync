-- Active: 1789798676715@@localhost@3306@unisync
...
-- Insert static Admin and User entries
INSERT INTO
...
-- Insert rooms
INSERT INTO
    rooms (name, annex, type_id)
VALUES ('E-101', 'Annex E', 1),
    ('E-102', 'Annex E', 1),
    ('G-101', 'Annex G', 4);
...
VALUES (1, 1), -- E-101 has Projector
    (1, 2), -- E-101 has PC
